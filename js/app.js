...
(function (g) {
  ...
  // Evidence, plan and analysis panels live in js/panels.js.
  const { renderOfficial, renderLab, updateEvTabs, renderChance, renderPlan, renderTarget, skillNote, renderFavCompare, reviewHtml, scienceHtml, evidenceChip, chanceAt, pickEvidence, EV, evLevel, pctTxt } = FH.panels({ state, store, spot, species, hookOpts: (sp, fish, c) => hookOpts(sp, fish, c) });
  let chart = null;
  let scene = null;
