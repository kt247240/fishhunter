...
(function (g) {
  ...
  const SPOTS = [
    // ── 新潟・上越 / 糸魚川 ─────────────────────────────
    { id: 'oyashirazu', name: '親不知', pref: '新潟', area: '上越', type: '磯・ゴロタ', water: 'sea', lat: 36.985, lon: 137.705, face: 330, depth: 'deep',
      species: ['inada', 'sagoshi', 'aori', 'kasago', 'madai', 'hirame'],
      feature: '急深な海岸。潮通しが良く、青物回遊の期待が高い。足場が険しい箇所が多い。', caution: '落石・高波。うねりが残る日は近づかない。' },
    { id: 'himeko', name: '姫川港', pref: '新潟', area: '上越', type: '港湾・河口', water: 'sea', lat: 37.049, lon: 137.838, face: 330, depth: 'mid',
      species: ['seabass', 'inada', 'sagoshi', 'aji', 'saba', 'aori', 'kasago'],
      feature: '姫川河口に隣接。河川水の流入でベイトが溜まりやすい。', caution: '港湾施設の立入禁止区域に注意。', feedAliases: ['姫川港', '姫川', '糸魚川'] },
    { id: 'nou-port', name: '能生漁港', pref: '新潟', area: '上越', type: '漁港', water: 'sea', lat: 37.097, lon: 137.983, face: 330, depth: 'mid',
      species: ['aori', 'aji', 'saba', 'kasago', 'kurodai', 'inada'],
      feature: '藻場のある磯が近く、秋のアオリイカで人気。', caution: '漁業者の作業優先。駐車マナー厳守。', feedAliases: ['能生', '能生漁港', 'マリンドリーム能生', '糸魚川'] },
    { id: 'tsutsuishi', name: '筒石漁港', pref: '新潟', area: '上越', type: '漁港', water: 'sea', lat: 37.119, lon: 138.036, face: 330, depth: 'mid',
      species: ['aori', 'aji', 'kasago', 'kurodai', 'saba'],
      feature: '舟屋の町並みが残る小規模漁港。周辺の磯場と合わせて探れる。', caution: '生活圏。騒音・ゴミに特に配慮。', feedAliases: ['筒石', '筒石漁港'] },
    { id: 'nadachi', name: '名立漁港', pref: '新潟', area: '上越', type: '漁港', water: 'sea', lat: 37.170, lon: 138.099, face: 330, depth: 'mid',
      species: ['aori', 'aji', 'saba', 'kasago', 'kurodai', 'kisu'],
      feature: '道の駅に近くアクセス良好。港内外で多魚種。', caution: '', feedAliases: ['名立', '名立漁港'] },
    { id: 'naoetsu', name: '直江津港', pref: '新潟', area: '上越', type: '港湾（管理釣り場あり）', water: 'sea', lat: 37.186, lon: 138.243, face: 340, depth: 'deep',
      species: ['inada', 'sagoshi', 'aji', 'saba', 'seabass', 'kurodai', 'aori', 'madai'],
      feature: '大型港湾。第3東防波堤はNPO法人による管理釣り場として運営（利用条件は公式で確認）。', caution: '管理釣り場は開場日・料金・ルールを公式サイトで確認。', feedAliases: ['直江津', '直江津港', '上越'] },
    { id: 'kuroi', name: '黒井突堤', pref: '新潟', area: '上越', type: '突堤・サーフ', water: 'sea', lat: 37.203, lon: 138.276, face: 340, depth: 'shallow',
      species: ['kisu', 'hirame', 'seabass', 'inada', 'sagoshi', 'saba'],
      feature: '砂浜に突き出した突堤。サーフの魚と回遊魚を両狙いできる。', caution: '波を被りやすい。高波時は立入らない。', feedAliases: ['黒井', '黒井突堤'] },
    { id: 'kakizaki', name: '柿崎・上下浜', pref: '新潟', area: '上越', type: 'サーフ', water: 'sea', lat: 37.270, lon: 138.380, face: 320, depth: 'shallow',
      species: ['kisu', 'hirame', 'seabass', 'inada'],
      feature: '遠浅のサーフが続く。キス・ヒラメの好フィールド。', caution: '離岸流に注意。' },
    // ── 新潟・中越 ──────────────────────────────────
    { id: 'kashiwazaki', name: '柏崎港', pref: '新潟', area: '中越', type: '港湾（管理釣り場あり）', water: 'sea', lat: 37.360, lon: 138.535, face: 320, depth: 'mid',
      species: ['aji', 'saba', 'inada', 'sagoshi', 'kurodai', 'aori', 'kasago'],
      feature: '中越の主要港。防波堤からの回遊魚が中心。', caution: '管理エリアのルールを確認。' },
    { id: 'kujiranami', name: '鯨波・番神', pref: '新潟', area: '中越', type: '磯・サーフ', water: 'sea', lat: 37.345, lon: 138.515, face: 300, depth: 'mid',
      species: ['kurodai', 'aori', 'kasago', 'kisu', 'hirame', 'madai'],
      feature: '磯とサーフが混在。夏場は海水浴客に配慮。', caution: '遊泳区域での釣りは不可。' },
    { id: 'izumozaki', name: '出雲崎', pref: '新潟', area: '中越', type: '漁港・磯', water: 'sea', lat: 37.535, lon: 138.707, face: 300, depth: 'mid',
      species: ['aori', 'kurodai', 'kasago', 'aji', 'madai'],
      feature: '夕日の名所。周辺の磯・小港を回遊しながら探れる。', caution: '' },
    { id: 'teradomari', name: '寺泊港', pref: '新潟', area: '中越', type: '漁港', water: 'sea', lat: 37.642, lon: 138.764, face: 290, depth: 'mid',
      species: ['aji', 'saba', 'kurodai', 'aori', 'kasago', 'inada'],
      feature: '魚市場通りで有名な港町。港内外で手軽に狙える。', caution: '観光客・車両の往来に注意。' },
    { id: 'ohkouzu', name: '大河津分水 河口', pref: '新潟', area: '中越', type: '河口', water: 'sea', lat: 37.666, lon: 138.790, face: 300, depth: 'shallow',
      species: ['seabass', 'hirame', 'kurodai', 'sakuramasu'],
      feature: '信濃川の分水河口。雨後の濁り・流れでシーバスの実績。', caution: '増水時は絶対に近づかない。' },
    // ── 新潟・下越 ──────────────────────────────────
    { id: 'niigata-west', name: '新潟西港', pref: '新潟', area: '下越', type: '港湾・河口', water: 'sea', lat: 37.935, lon: 139.058, face: 330, depth: 'deep',
      species: ['seabass', 'kurodai', 'aji', 'saba', 'inada', 'sagoshi'],
      feature: '信濃川河口の大型港。都市型シーバスの定番エリア。', caution: '港湾保安区域は立入禁止。' },
    { id: 'niigata-east', name: '新潟東港', pref: '新潟', area: '下越', type: '港湾（管理釣り場あり）', water: 'sea', lat: 37.995, lon: 139.228, face: 330, depth: 'deep',
    ...
    { id: 'aganogawa', name: '阿賀野川 河口', pref: '新潟', area: '下越', type: '河口', water: 'sea', lat: 37.962, lon: 139.117, face: 330, depth: 'shallow',
      species: ['seabass', 'hirame', 'kurodai', 'sakuramasu'],
      feature: '大河川の河口。ベイト・流れが豊富。', caution: '河川内は漁協の規則を確認。' },
    { id: 'iwafune', name: '岩船港', pref: '新潟', area: '下越', type: '港湾', water: 'sea', lat: 38.195, lon: 139.420, face: 300, depth: 'mid',
      species: ['aji', 'saba', 'aori', 'kurodai', 'inada', 'kasago'],
      feature: '村上エリアの拠点港。佐渡汽船・漁港の複合。', caution: '' },
    { id: 'sasagawa', name: '笹川流れ', pref: '新潟', area: '下越', type: '磯', water: 'sea', lat: 38.380, lon: 139.475, face: 280, depth: 'deep',
      species: ['aori', 'kurodai', 'madai', 'kasago', 'inada', 'hirame'],
      feature: '奇岩が連なる景勝地。透明度が高く磯の釣りが魅力。', caution: '磯場は波・滑落に注意。ライフジャケット必携。' },
    // ── 佐渡 ────────────────────────────────────────
    { id: 'ryotsu', name: '両津港', pref: '新潟', area: '佐渡', type: '港湾', water: 'sea', lat: 38.083, lon: 138.438, face: 90, depth: 'mid',
      species: ['aji', 'saba', 'aori', 'inada', 'kurodai', 'kasago'],
      feature: '佐渡の玄関口。加茂湖に隣接し多彩な魚種。', caution: 'フェリー発着エリアは立入不可。' },
    { id: 'washizaki', name: '鷲崎', pref: '新潟', area: '佐渡', type: '磯・漁港', water: 'sea', lat: 38.320, lon: 138.510, face: 0, depth: 'deep',
      species: ['inada', 'madai', 'aori', 'kasago', 'kurodai'],
      feature: '佐渡北端。潮通し抜群の外洋エリア。', caution: '北西風時は大荒れ。' },
    { id: 'ogi', name: '小木港', pref: '新潟', area: '佐渡', type: '港湾・磯', water: 'sea', lat: 37.815, lon: 138.284, face: 200, depth: 'mid',
      species: ['aori', 'aji', 'kurodai', 'madai', 'kasago', 'inada'],
      feature: '佐渡南端。冬の北西風の影響を受けにくい南向き。', caution: '' },
    // ── 新潟・内水面 ─────────────────────────────────
    { id: 'uonogawa', name: '魚野川', pref: '新潟', area: '中越', type: '河川', water: 'river', lat: 37.110, lon: 138.935, elev: 200,
      species: ['ayu', 'yamame', 'iwana', 'niji', 'sakuramasu'],
      feature: '魚沼の清流。アユ・渓流魚・サクラマスの名川。', caution: '雪代期は水量・水温変化が大きい。' },
    { id: 'arakawa', name: '荒川（村上）', pref: '新潟', area: '下越', type: '河川', water: 'river', lat: 38.120, lon: 139.500, elev: 30,
      species: ['ayu', 'sakuramasu', 'yamame', 'seabass'],
      feature: 'サクラマス・アユで知られる清流。', caution: 'サクラマスは特別な承認・期間の定めあり。' },
    { id: 'okutadami', name: '奥只見湖', pref: '新潟', area: '中越', type: 'ダム湖', water: 'lake', lat: 37.150, lon: 139.240, elev: 780,
      species: ['iwana', 'sakuramasu', 'niji'],
      feature: '山深い大型ダム湖。ボートでの大型トラウト狙い。', caution: '期間・遊漁券・ボート規定あり。天候急変に注意。' },
    // ── 長野・北信 ──────────────────────────────────
    { id: 'nojiri', name: '野尻湖', pref: '長野', area: '北信', type: '湖', water: 'lake', lat: 36.827, lon: 138.216, elev: 657,
      species: ['bass', 'wakasagi', 'niji'],
      feature: 'スモールマウスバスの聖地。秋〜冬はドーム船ワカサギ。', caution: '遊漁期間・遊漁券・禁止エリアは漁協で確認。' },
    { id: 'chikuma-nagano', name: '千曲川（長野市〜須坂）', pref: '長野', area: '北信', type: '本流', water: 'river', lat: 36.650, lon: 138.270, elev: 340,
      species: ['niji', 'ayu', 'bass', 'yamame'],
      feature: '犀川合流を含む本流域。大型ニジマス・スモールの実績。', caution: '本流は流れが強く水位変化も大きい。' },
    { id: 'saikawa', name: '犀川（安曇野〜信州新町）', pref: '長野', area: '中信', type: '本流', water: 'river', lat: 36.440, lon: 137.960, elev: 480,
      species: ['niji', 'yamame', 'iwana'],
      feature: 'ダム放流の影響を受ける本流。大型レインボーの名川。', caution: 'ダム放流による急な増水に最大限注意。' },
    // ── 長野・中信 ──────────────────────────────────
    { id: 'kizaki', name: '木崎湖', pref: '長野', area: '中信', type: '湖', water: 'lake', lat: 36.555, lon: 137.835, elev: 764,
      species: ['bass', 'wakasagi', 'niji'],
      feature: '仁科三湖の一つ。スモールマウス・ワカサギ。', caution: '遊漁券必須。' },
    { id: 'aoki', name: '青木湖', pref: '長野', area: '中信', type: '湖', water: 'lake', lat: 36.617, lon: 137.852, elev: 822,
      species: ['niji', 'iwana', 'bass'],
      feature: '透明度の高い深い湖。トラウトの実績。', caution: '遊漁規則を確認。' },
    { id: 'azusa', name: '梓川', pref: '長野', area: '中信', type: '渓流〜本流', water: 'river', lat: 36.225, lon: 137.850, elev: 650,
      species: ['iwana', 'yamame', 'niji'],
      feature: '北アルプス由来の冷水。イワナ・ニジマス。', caution: 'ダム放流・急な増水に注意。' },
    { id: 'takase', name: '高瀬川', pref: '長野', area: '中信', type: '渓流', water: 'river', lat: 36.500, lon: 137.820, elev: 650,
      species: ['iwana', 'yamame', 'niji'],
      feature: '北アルプスからの清冽な流れ。', caution: '熊・増水に注意。' },
    { id: 'narai', name: '奈良井川', pref: '長野', area: '中信', type: '渓流', water: 'river', lat: 36.050, lon: 137.850, elev: 800,
      species: ['iwana', 'yamame'],
      feature: '木曽谷へ続く渓流。', caution: '遊漁券必須。' },
    // ── 長野・東信 ──────────────────────────────────
    { id: 'chikuma-ueda', name: '千曲川（上田）', pref: '長野', area: '東信', type: '本流', water: 'river', lat: 36.395, lon: 138.255, elev: 440,
      species: ['ayu', 'niji', 'yamame'],
      feature: '大型アユで知られる区間。', caution: '解禁日・区間を漁協で確認。' },
    { id: 'matsubara', name: '松原湖', pref: '長野', area: '東信', type: '湖', water: 'lake', lat: 36.052, lon: 138.440, elev: 1123,
      species: ['wakasagi', 'niji'],
      feature: '高原の湖。冬は結氷状況次第で氷上ワカサギ。', caution: '氷上は管理者の解禁発表に従う。' },
    // ── 長野・南信 ──────────────────────────────────
    { id: 'suwa', name: '諏訪湖', pref: '長野', area: '南信', type: '湖', water: 'lake', lat: 36.047, lon: 138.085, elev: 759,
      species: ['wakasagi', 'bass'],
      feature: 'ワカサギの名湖。ドーム船・桟橋釣りが中心。', caution: '遊漁期間・遊漁券は漁協で確認。' },
    { id: 'tenryu', name: '天竜川（伊那）', pref: '長野', area: '南信', type: '本流', water: 'river', lat: 35.840, lon: 137.960, elev: 630,
      species: ['ayu', 'yamame', 'niji'],
      feature: 'アユ・アマゴの本流。', caution: 'ダム放流・増水に注意。' },
    { id: 'kiso', name: '木曽川（上松）', pref: '長野', area: '南信', type: '渓流〜本流', water: 'river', lat: 35.780, lon: 137.695, elev: 700,
