...
const SHELL = [
  ...
  'js/catchlog.js', 'js/engine.js', 'js/insight.js', 'js/science.js', 'js/motion.js', 'js/ui.js', 'js/scene.js', 'js/map.js', 'js/picks-worker.js', 'js/share.js', 'js/prefs.js', 'js/app.js', 'js/ptr.js',
